...
class TestUserPreference(TestCase):
    ...
    @patch('air_sdk.user_preference.util.raise_if_invalid_response')
    ...
    @patch('air_sdk.user_preference.util.raise_if_invalid_response')
    @patch('air_sdk.user_preference.UserPreference._build_url', return_value=None)
    ...
    @patch('air_sdk.user_preference.UserPreference._load')
    ...
    @patch('air_sdk.simulation.Simulation.preferences')
    @patch('air_sdk.user_preference.UserPreference._load')
    ...
    @patch('air_sdk.user_preference.util.raise_if_invalid_response')
    @patch('air_sdk.user_preference.UserPreference.refresh')
