...
class TestTopologyApi(TestCase):
    ...
    @patch('air_sdk.topology.TopologyApi.get')
    ...
    def test_create_dot(self, mock_raise, *args):
        ...
        with patch('air_sdk.topology.logger.warning') as mock_log:
