...
class TestSimulationNode(TestCase):
    ...
    @patch('air_sdk.simulation_node.SimulationNode.control')
...
class TestSimulationNodeApi(TestCase):
    ...
    @patch('air_sdk.simulation_node.SimulationNodeApi.get')
    ...
    @patch('air_sdk.simulation_node.SimulationNodeApi.list')
